...
public class Pregunta5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        op1= (Button) findViewById(R.id.cincoam_bttn);
        op2= (Button) findViewById(R.id.doceam_bttn);
        op3= (Button) findViewById(R.id.oncepm_bttn);
        op4= (Button) findViewById(R.id.dosam_bttn);
    }
